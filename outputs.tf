...
output "eni_id" {
  ...
  value       = try(module.nat_instance[0].eni_id, "")
}
...
output "eni_private_ip" {
  ...
  value = try(module.nat_instance[0].eni_private_ip, "")
}

output "sg_id" {
  description = "ID of the security group of the NAT instance"
  value       = try(module.nat_instance[0].sg_id, "")
}

output "iam_role_name" {
  description = "Name of the IAM role for the NAT instance"
  value       = try(module.nat_instance[0].iam_role_name, "")
}
